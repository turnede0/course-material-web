...
export const CourseInfo: CourseInfoType = [
    ...
    courses: [
...

      {
        ...
        },
        {
          ...
          downloadUrl:
            "https://stemturnede.sharepoint.com/:f:/g/EhC_F5AuRJRKgRAONuwReukB0J1OSZOzxNtZwIImeVCBxg?e=rcaS9k", 
        },
        {
          topic: "焊接教學",
          downloadUrl:
      ...
      {
        courseName: "Microbit X PCB 簡易入門課程",
        courseID: "PCB01.12",
        description:
          "通過15小時的課程，同學學習使用micro:bit， 由0開始製作智能家居語音溫濕度傳感器專題。",
        categoryID: "PCB",
        image:
          "https://i.imgur.com/CNSWNHa.png",
        resources: [          
        {
          topic: " Lesson 1-3 Microbit 智能家居語音溫濕度傳感器",
          downloadUrl:
            "https://stemturnede.sharepoint.com/:f:/g/EtjveCJa4m9Jo2ivs7olQnMBmuwkPQlhMZnv86RfsejOWw?e=9d82pD",
        },
        {
          topic: " Lesson 4-9 PCB設計",
          downloadUrl:
  ...
  },
  {
    ...
    courses: [
      ...
      {
        courseName: "MCKLN Workshop 2024",
        courseID: "MCKLN001",
        description: "HCW Workshop 2024",
        categoryID: "workshop",
        image:
        ...
        resources: [
          {
            topic: "HCW Workshop 2024",
            downloadUrl:
              "https://stemturnede.sharepoint.com/:f:/g/EuFZbTNROPlFuDlmvI5S2V4BEUaZGn1w7SLHWnrSoG7hHg?e=tnLPqw",
          },
        ],
      },
      {
      ...
      {
        courseName: "香港電子科技商會 - IFF 2024 微電子主題工作坊",
        courseID: "HKETAIFF2024",
      ...
      },
      {
        ...
        resources: [
          ...
          },
          {
            topic: "複製文本",
            downloadUrl:
              "https://stemturnede.sharepoint.com/:w:/s/PunchCardRDProject/EXIXluUprvtLg3AkWLYU2rUB1Uq8hA4LVOPpYb1P45koKA?e=OJZGhu",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    courses: [
      ...
      {
        courseName: "AMD X Avnet Certificate Course",
        courseID: "AMD001",
